...
public class FxExperienceSplash extends Application {
    ...
    private static final String SPLASH_LOADING_MESSAGE = "Loading hobbits with pie . . .";
    ...
    public void init() {
        ImageView splash = new ImageView(
                new Image(
                        ...
                        this.getClass().getResource("/assets/images/social-pipes-splash.png").toString()
                )
        );
        loadProgress = new ProgressBar();
        loadProgress.setPrefWidth(SPLASH_WIDTH - 20);
        loadProgress.setStyle("-fx-width: 80%");

        progressText = new Label(SPLASH_LOADING_MESSAGE);
